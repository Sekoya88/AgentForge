    ...
    <div className="mx-auto max-w-7xl px-4 pb-16 pt-8 md:px-8">
      ...
      {agents && agents.length === 0 && (
        <div className="flex min-h-[300px] flex-col items-center justify-center rounded-xl border border-dashed border-af-border/60 bg-af-surface-container/20 p-12 text-center shadow-inner">
          ...
          <h3 className="mb-2 font-bold text-white text-lg">No agents yet</h3>
          <p className="mb-6 max-w-sm text-sm text-af-muted">
            Get started by initializing your first autonomous agent. Define its behavior and connect it to your toolset.
          </p>
          <Link
            href="/agents/new"
